...
DEFINE_FIELD(m_pGoalEnt, FIELD_CLASSPTR),
	...
	DEFINE_FIELD(m_ConfigReplacementFileName, FIELD_STRING),
	...
	DEFINE_ARRAY( m_InheritKey, FIELD_STRING, SHARED_KEYVALUE_MAX ),
	DEFINE_ARRAY( m_InheritValue, FIELD_STRING, SHARED_KEYVALUE_MAX ),
	DEFINE_FIELD( m_InheritKeyValues, FIELD_INTEGER ),
