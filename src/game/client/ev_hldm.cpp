...
void EV_FireShotGunDouble(event_args_t* args)
{
	...
	if (g_Skill.GetValue("shotgun_double_wide_spread", 0) != 0)
	{
...
void EV_FireShotGunSingle(event_args_t* args)
{
	...
	if (g_Skill.GetValue("shotgun_single_tight_spread", 0) != 0)
	{
...
void EV_FirePython(event_args_t* args)
{
	...
	if (EV_IsLocal(idx))
	{
		const int body = g_Skill.GetValue("revolver_laser_sight", 0) != 0 ? 1 : 0;
